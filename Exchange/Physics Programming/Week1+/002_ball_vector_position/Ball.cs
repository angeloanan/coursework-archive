...
public class Ball : EasyDraw
{
	...
	void KeyControls() {
        ...
        int timeSinceStart = Time.time;
        _speed = (Time.time / 5000f) * 5f;

        Vec2 velocity = new Vec2(Input.mouseX - _position.x, Input.mouseY - _position.y);
        velocity.SetLength(_speed);
